...
const mockPrompts: Prompt[] = [
  ...
  {
    id: "5",
    title: "Prompt para Logo Minimalista Profissional",
    category: "dalle",
    price: 9.99,
    description: "Crie logos modernos e minimalistas para empresas com este prompt profissional. Perfeito para startups e negócios inovadores.",
    content: "minimalist professional logo design for [COMPANY], clean typography, geometric shapes, modern aesthetic, vector style, simple color palette, scalable design, corporate identity, negative space usage --ar 1:1",
    tags: ["logo", "minimalista", "profissional", "negócios"],
    rating: 4.6,
    downloads: 1543,
    views: 8920,
    author: "Design Pro",
  ...
  {
    id: "6",
    title: "Arquitetura Futurista Cyberpunk",
    category: "midjourney",
    price: 0,
    description: "Prompt gratuito para criar cenários arquitetônicos futuristas no estilo cyberpunk com neon e elementos high-tech.",
    content: "futuristic cyberpunk architecture, neon lights, holographic displays, dark atmosphere, rain reflections, vertical city, flying vehicles, high-tech buildings, urban sprawl, cinematic lighting --ar 16:9 --v 6",
    tags: ["cyberpunk", "futurismo", "arquitetura", "neon"],
    rating: 4.7,
    downloads: 4521,
    views: 22100,
    author: "Cyber Artist",
